...
scr='aws-r53-dynamic-update.sh'


@test "Should print help successfully if requested" {
  skip "TEST CASE TO BE ADDED: -h"
  run $scr -h
...
@test "Should execute 'aws route53 change-resource-record-sets' command" {
  skip "TEST CASE NEEDS TO BE ADDED"
  run $scr
